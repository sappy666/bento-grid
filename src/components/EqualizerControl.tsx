...
export const EqualizerControl: React.FC<EqualizerControlProps> = ({
  ...
  return (
    <div className="w-full p-3 sm:p-4 rounded-2xl bg-white/90 dark:bg-[#1A1A1A]/90 backdrop-blur-md border border-neutral-300/80 dark:border-neutral-800 shadow-sm transition-all">
      <div className="flex items-center justify-between pb-3 mb-3 border-b border-neutral-200 dark:border-neutral-800 text-xs font-mono">
        ...
        <button
          type="button"
          onClick={onReset}
          className="p-1 rounded-md text-neutral-400 hover:text-neutral-800 dark:hover:text-white transition-colors"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
        ...
        <div className="flex flex-col gap-2">
          <div className="flex items-center justify-between text-xs font-mono">
            ...
            <span className="px-2 py-0.5 rounded-md bg-neutral-100 dark:bg-neutral-800 text-neutral-900 dark:text-white font-bold">
              {borderRadius}px
            </span>
          </div>
          ...
          <div className="relative flex items-center py-1">
            <input
              ...
              className="w-full h-2 rounded-lg bg-neutral-200 dark:bg-neutral-800 appearance-none cursor-pointer accent-neutral-900 dark:accent-white focus:outline-none"
            ...
            {radiusPresets.map((r) => (
              <button
                ...
                className={`px-1.5 py-0.5 rounded hover:bg-neutral-200 dark:hover:bg-neutral-800 transition-colors ${
                  borderRadius === r ? 'text-neutral-900 dark:text-white font-bold' : ''
                }`}
              >
                {r}px
              </button>
          ...
          <div className="flex items-center justify-between text-[10px] font-mono text-neutral-400">
            {gapPresets.map((g) => (
              <button
                ...
                className={`px-1.5 py-0.5 rounded hover:bg-neutral-200 dark:hover:bg-neutral-800 transition-colors ${
                  gap === g ? 'text-neutral-900 dark:text-white font-bold' : ''
                }`}
              >
                {g}px
              </button>
